...
var blaster = require('pi-blaster/pi-blaster.js');
...
var ONE_DEGREE_VAL = (MAX_VALUE - MIN_VALUE) / TOTAL_DEGREES;
...
function moveMotor(motor, position, callback)
{
  ...
  blaster.setPwm(motor.PIN, parseFloat(position), callback);
}
...
function Export() {
  ...
  // constants
  this.ONE_DEGREE_VAL = ONE_DEGREE_VAL;
