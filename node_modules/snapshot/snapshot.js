...
module.exports = {
  snapImage: function(dir, imgOut, callback)
  {
    ...
    var photoNum = 0;
    var i = 1;
    for (; i < servo.TOTAL_DEGREES / servo.motorHorizontal_.DEG_PER_IMG; ++i)
    {
      var degree = i * servo.ONE_DEGREE_VAL * servo.motorHorizontal_.DEG_PER_IMG;
...
function capture(path)
{
  ...
  shell.exec("fswebcam --jpeg 100 --rotate 90 " + path)
}
