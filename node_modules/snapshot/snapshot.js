...
var PHOTO_DIR = "/home/ees37/workspace/snapshot/public/images/plants/"
...
module.exports = {
  snapImage: function(dir, imgOut, callback)
  {
    ...
    setTimeout(function()
    {
       ...
       callback();
    }, servo.TOTAL_DEGREES / servo.motorHorizontal_.DEG_PER_IMG);
  },

  stitchPhotos: function(dir, imgOut)
  {
